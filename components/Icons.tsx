...
const Icons = {
    ...
    metricsLoading: (props) => (
        <svg {...props} version="1.1" id="L1" className="fill-black" x="0px" y="0px" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
            <circle fill="none" className="stroke-yellow-500" stroke-width="6" stroke-miterlimit="15" stroke-dasharray="14.2472,14.2472" cx="50" cy="50" r="47" >
                <animateTransform
            ...
            <circle fill="none" stroke="orange" stroke-width="1" stroke-miterlimit="10" stroke-dasharray="10,10" cx="50" cy="50" r="39">
                <animateTransform
                    attributeName="transform"
                    attributeType="XML"
                    type="rotate"
    ...
    userListLoading: (props) => {
        return (
            <svg {...props} version="1.1" id="L7" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 100 100" enable-background="new 0 0 100 100" >
                <path className="fill-yellow-400" d="M31.6,3.5C5.9,13.6-6.6,42.7,3.5,68.4c10.1,25.7,39.2,38.3,64.9,28.1l-3.1-7.9c-21.3,8.4-45.4-2-53.8-23.3
  c-8.4-21.3,2-45.4,23.3-53.8L31.6,3.5z">
                ...
                <path className="fill-green-600" d="M42.3,39.6c5.7-4.3,13.9-3.1,18.1,2.7c4.3,5.7,3.1,13.9-2.7,18.1l4.1,5.5c8.8-6.5,10.6-19,4.1-27.7
  c-6.5-8.8-19-10.6-27.7-4.1L42.3,39.6z">
                ...
                <path className="fill-lime-700" d="M82,35.7C74.1,18,53.4,10.1,35.7,18S10.1,46.6,18,64.3l7.6-3.4c-6-13.5,0-29.3,13.5-35.3s29.3,0,35.3,13.5
  L82,35.7z">
                    <animateTransform
                        attributeName="transform"
                        attributeType="XML"
    ...
    codeGenerationLoading: (props) => {
        return (
            <svg {...props} xmlns="http://www.w3.org/2000/svg" className="bg-transparent" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
