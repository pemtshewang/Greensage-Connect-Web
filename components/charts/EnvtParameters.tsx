    ...
    <div className="graph-selector border-2 relative border-muted-foreground">
      ...
      < ResponsiveContainer width="100%" height={400} >
        ...
        >
          ...
          <Scatter name="temperature" data={data.TemperatureThresholdRecord} fill="#ff0000" line shape="cross" />
          <Scatter name="humidity" data={data.HumidityThresholdRecord} fill="blue" line shape="triangle" />
          <Scatter name="soilMoisture" data={data.SoilMoistureThresholdRecord} fill="yellow" line shape="diamond" />
        </ScatterChart>
      </ResponsiveContainer >
    </div>
  )
