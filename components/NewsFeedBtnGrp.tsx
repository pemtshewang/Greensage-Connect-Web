...
export default function ButtonGroup() {
  ...
  return (
    <div className="ml-auto mr-2 w-fit flex flex-col space-y-5 lg:max-w-[130px]">
      ...
      <AlertHelper />
      <NewsFeedForm isNewsFeedFormVisible={isNewsFormVisible} setIsNewsFeedFormVisible={setIsNewsFormVisible} />
    </div>
  )
}
